...
The data is avaiable [here, through Google Drive](https://drive.google.com/drive/folders/1VM3KzQNL8qH-H4EjY_S6_63mX1j0mRwT?usp=sharing). 
...
- When using the `NELL-One` and `Wiki-One`, don't forget to cite [One-Shot Relational Learning for Knowledge Graphs](https://arxiv.org/pdf/1808.09040.pdf).