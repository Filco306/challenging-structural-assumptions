...
def fix_relationdescriptions_wiki():
    ...
    with open(os.path.join("origin_data", dataset, "relation2ids"), "r") as f:
        new_rel2id = json.load(f)

    with open(
        os.path.join("origin_data", dataset, "relationdescriptions"), "r"
    ) as f:
    ...
    with open(
        os.path.join("origin_data", dataset, "relationdescriptions"), "w"
    ) as f:
