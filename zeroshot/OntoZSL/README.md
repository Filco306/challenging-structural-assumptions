# Code for OntoZSL experiments

*NOTE:* This is the code for the OntoZSL experiments used. I (Filip Cornell) am not the author of this code originally; Please refer to the [original work](https://arxiv.org/abs/2102.07339); this is the slightly modified and adapted version used for the experiments in the paper that this repository belongs to ([Challenging the Assumption of Structure-based embeddings in Few- and Zero-shot Knowledge Graph Completion](https://aclanthology.org/2022.lrec-1.677/)). If you use this code, make sure to also cite [OntoZSL](https://arxiv.org/abs/2102.07339) that develop the model architecture. 
